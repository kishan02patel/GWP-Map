...
class Map extends React.Component {
	constructor(props) {
		...
		this.STROKE_COLOR = this.props.strokeColor || '#000000';
		this.STROKE_WIDTH = this.props.strokeWidth || 0.5;
		this.STROKE_LINECAP = this.props.strokeLinecap || 'round';
		this.STROKE_LINEJOIN = this.props.strokeLinejoin || 'round';
		this.FILL_OPACITY = this.props.fillOpacity || '0.8';
	}
		...
		*/
		...
		for (var key in dataPoints) {
			...
			this.svg.append("path")
				.attr("d", lineFunction(dataPoints[key]))
				.attr("stroke", "blue")
				.attr("stroke-width", 2)
				.attr("fill", "none");
		}
